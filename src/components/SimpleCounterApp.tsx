  ...
  public render() {
    ...
    return (
      <Paper className={classes.root}>
        <div className={classes.header}>{title || 'Simple Counter'}</div>
        <div className={classes.container}>
          <span className={classes.counter}>{counter}</span>
        </div>
        <div className={classes.buttonContainer}>
          <Button className={classes.button} variant="contained" color="primary" onClick={this._onClicked}>
            {increment ? 'INCREMENT' : 'DECREMENT'}
          </Button>
          <Button className={classes.button} variant="contained" color="secondary" onClick={this._toggleIncrement}>
            REVERSE
          </Button>
        </div>
      </Paper>
